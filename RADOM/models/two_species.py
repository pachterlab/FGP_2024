...
def update_theta_j_unrestricted(theta0, x_weighted, marginal_weight, t, tau, topo, Ub=1, lambda_a=0, bnd=10000, bnd_beta=1000, miter=1000):
    """
    with jac
...
def update_theta_j_restricted(theta0, x_weighted, marginal_weight, t, tau, topo, restrictions, Ub=1, lambda_a=0, bnd=10000, bnd_beta=1000, miter=1000):
